...
public class RestPatchCallTypeInvoker implements ICallTypeInvoker {
    public Map<String, Object> executeCallType(BizModuleInfo info, Map<String, Object> inData){
        Map<String, Object> outData = new OKHttpRestAPI().doPatch(info.getCallHost() + "/" + info.getCallInfo(), inData);
        return outData;
    }
}
