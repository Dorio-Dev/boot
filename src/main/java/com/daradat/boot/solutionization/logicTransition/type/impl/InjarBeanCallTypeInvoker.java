...
import com.daradat.boot.solutionization.logicTransition.bean.BeanFinder;
...
public class InjarBeanCallTypeInvoker implements ICallTypeInvoker {
    public Map<String, Object> executeCallType(BizModuleInfo info, Map<String, Object> inData){
        ...
        Class<?> c = sr.loadClass(info.getCallHost(), info.getCallInfo());
        Object o = BeanFinder.createBean(c);
        IDoBizRule bizRule = (IDoBizRule)o;
